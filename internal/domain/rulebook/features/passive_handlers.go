...
func (h *KeenSensesHandler) ApplyPassiveEffects(character *character.Character) error {
...
func (h *KeenSensesHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
	// Keen Senses doesn't modify skill checks beyond granting proficiency
	return baseResult, false
}

func (h *KeenSensesHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
...
func (h *DarkvisionHandler) ApplyPassiveEffects(character *character.Character) error {
...
func (h *DarkvisionHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
...
func (h *DarkvisionHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
...
func (h *StonecunningHandler) ApplyPassiveEffects(character *character.Character) error {
...
func (h *StonecunningHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
...
func (h *StonecunningHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
...
func (h *BraveHandler) ApplyPassiveEffects(character *character.Character) error {
	// Brave is a situational feature that affects fear saves
	// No permanent character modifications needed
	return nil
}

func (h *BraveHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
	// Brave affects saving throws, not skill checks
	return baseResult, false
}

func (h *BraveHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
...
func (h *DwarvenResilienceHandler) ApplyPassiveEffects(character *character.Character) error {
	// Dwarven Resilience provides situational bonuses
	// No permanent character modifications needed
	return nil
}

func (h *DwarvenResilienceHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
	// Affects saves, not skill checks
	return baseResult, false
}

func (h *DwarvenResilienceHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
...
func (h *FeyAncestryHandler) ApplyPassiveEffects(character *character.Character) error {
	// Fey Ancestry provides situational bonuses
	// No permanent character modifications needed
	return nil
}

func (h *FeyAncestryHandler) ModifySkillCheck(character *character.Character, skillKey string, baseResult int) (int, bool) {
	// Affects saves, not skill checks
	return baseResult, false
}

func (h *FeyAncestryHandler) GetPassiveDisplayInfo(character *character.Character) (string, bool) {
