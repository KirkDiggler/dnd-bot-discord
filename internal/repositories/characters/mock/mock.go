...
func (mr *MockRepositoryMockRecorder) Create(ctx, character interface{}) *gomock.Call {
...
func (mr *MockRepositoryMockRecorder) GetByOwner(ctx, ownerID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetByOwnerAndRealm(ctx, ownerID, realmID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Update(ctx, character interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
