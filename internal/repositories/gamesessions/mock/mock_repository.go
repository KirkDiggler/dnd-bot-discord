...
//
//	mockgen -destination=mock/mock_repository.go -package=mockgamesessions -source=repository.go
//
...
func (m *MockRepository) Create(ctx context.Context, arg1 *session.Session) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetActiveByRealm(ctx context.Context, realmID string) ([]*session.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetActiveByRealm(ctx, realmID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) GetActiveByUser(ctx context.Context, userID string) ([]*session.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetActiveByUser(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) GetByInviteCode(ctx context.Context, code string) (*session.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetByInviteCode(ctx, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) GetByRealm(ctx context.Context, realmID string) ([]*session.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetByRealm(ctx, realmID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) GetByUser(ctx context.Context, userID string) ([]*session.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetByUser(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRepository) Update(ctx context.Context, arg1 *session.Session) error {
	m.ctrl.T.Helper()
