...
func (h *KeenSensesHandler) ApplyPassiveEffects(character *entities.Character) error {
	// Grant Perception proficiency
	perceptionProf := &entities.Proficiency{
		Key:  "skill-perception",
		Name: "Perception",
		Type: entities.ProficiencyTypeSkill,
	}

	character.AddProficiency(perceptionProf)
	return nil
}

func (h *KeenSensesHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
	// Keen Senses doesn't modify skill checks beyond granting proficiency
	return baseResult, false
}

func (h *KeenSensesHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
	// Check if character has Perception proficiency (might be from this feature or others)
	if character.HasSkillProficiency("skill-perception") {
...
func (h *DarkvisionHandler) ApplyPassiveEffects(character *entities.Character) error {
...
func (h *DarkvisionHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
...
func (h *DarkvisionHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
...
func (h *StonecunningHandler) ApplyPassiveEffects(character *entities.Character) error {
...
func (h *StonecunningHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
...
func (h *StonecunningHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
...
func (h *BraveHandler) ApplyPassiveEffects(character *entities.Character) error {
	// Brave is a situational feature that affects fear saves
	// No permanent character modifications needed
	return nil
}

func (h *BraveHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
	// Brave affects saving throws, not skill checks
	return baseResult, false
}

func (h *BraveHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
...
func (h *DwarvenResilienceHandler) ApplyPassiveEffects(character *entities.Character) error {
	// Dwarven Resilience provides situational bonuses
	// No permanent character modifications needed
	return nil
}

func (h *DwarvenResilienceHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
	// Affects saves, not skill checks
	return baseResult, false
}

func (h *DwarvenResilienceHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
...
func (h *FeyAncestryHandler) ApplyPassiveEffects(character *entities.Character) error {
	// Fey Ancestry provides situational bonuses
	// No permanent character modifications needed
	return nil
}

func (h *FeyAncestryHandler) ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool) {
	// Affects saves, not skill checks
	return baseResult, false
}

func (h *FeyAncestryHandler) GetPassiveDisplayInfo(character *entities.Character) (string, bool) {
