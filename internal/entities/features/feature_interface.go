...
type FeatureHandler interface {
	...
	ApplyPassiveEffects(character *entities.Character) error

	// ModifySkillCheck allows features to modify skill checks
	// Returns the modified result and whether the feature applied
	ModifySkillCheck(character *entities.Character, skillKey string, baseResult int) (int, bool)
	...
	GetPassiveDisplayInfo(character *entities.Character) (string, bool)
}
...
func (r *FeatureRegistry) ApplyAllPassiveEffects(character *entities.Character) error {
...
func (r *FeatureRegistry) GetAllPassiveDisplayInfo(character *entities.Character) []string {
