...
func (mr *MockServiceMockRecorder) GenerateLootTable(ctx, challengeRating interface{}) *gomock.Call {
...
func (mr *MockServiceMockRecorder) GenerateTreasure(ctx, difficulty, roomNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
