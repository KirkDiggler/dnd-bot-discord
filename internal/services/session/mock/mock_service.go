...
func (m *MockService) CreateSession(ctx context.Context, input *session.CreateSessionInput) (*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) CreateSession(ctx, input interface{}) *gomock.Call {
...
func (mr *MockServiceMockRecorder) DeleteSession(ctx, sessionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) EndSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) GetSession(ctx context.Context, sessionID string) (*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetSession(ctx, sessionID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) GetSessionByInviteCode(ctx context.Context, code string) (*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetSessionByInviteCode(ctx, code interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) InviteToSession(ctx, sessionID, inviterID, inviteeID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) JoinSession(ctx context.Context, sessionID, userID string) (*entities.SessionMember, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "JoinSession", ctx, sessionID, userID)
	ret0, _ := ret[0].(*entities.SessionMember)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// JoinSession indicates an expected call of JoinSession.
func (mr *MockServiceMockRecorder) JoinSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) JoinSessionByCode(ctx context.Context, code, userID string) (*entities.SessionMember, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) JoinSessionByCode(ctx, code, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) LeaveSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ListActiveRealmSessions(ctx context.Context, realmID string) ([]*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ListActiveRealmSessions(ctx, realmID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ListActiveUserSessions(ctx context.Context, userID string) ([]*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ListActiveUserSessions(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ListRealmSessions(ctx context.Context, realmID string) ([]*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ListRealmSessions(ctx, realmID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ListUserSessions(ctx context.Context, userID string) ([]*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ListUserSessions(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) PauseSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ResumeSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) SaveSession(ctx context.Context, session *entities.Session) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) SaveSession(ctx, session interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveSession", reflect.TypeOf((*MockService)(nil).SaveSession), ctx, session)
}
...
func (mr *MockServiceMockRecorder) SelectCharacter(ctx, sessionID, userID, characterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) StartSession(ctx, sessionID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) UpdateSession(ctx context.Context, sessionID string, input *session.UpdateSessionInput) (*entities.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) UpdateSession(ctx, sessionID, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
