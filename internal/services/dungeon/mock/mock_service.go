...
//
//	mockgen -destination=mock/mock_service.go -package=mockdungeon -source=service.go
//
...
import (
	...
	exploration "github.com/KirkDiggler/dnd-bot-discord/internal/domain/game/exploration"
...
func (mr *MockServiceMockRecorder) AbandonDungeon(ctx, dungeonID any) *gomock.Call {
...
func (mr *MockServiceMockRecorder) CompleteRoom(ctx, dungeonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) CreateDungeon(ctx context.Context, input *dungeon.CreateDungeonInput) (*exploration.Dungeon, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateDungeon", ctx, input)
	ret0, _ := ret[0].(*exploration.Dungeon)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) EnterRoom(ctx context.Context, dungeonID string) (*exploration.DungeonRoom, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnterRoom", ctx, dungeonID)
	ret0, _ := ret[0].(*exploration.DungeonRoom)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// EnterRoom indicates an expected call of EnterRoom.
func (mr *MockServiceMockRecorder) EnterRoom(ctx, dungeonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetAvailableActions(ctx, dungeonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) GetDungeon(ctx context.Context, dungeonID string) (*exploration.Dungeon, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetDungeon(ctx, dungeonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) JoinDungeon(ctx, dungeonID, userID, characterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ProceedToNextRoom(ctx context.Context, dungeonID string) (*exploration.DungeonRoom, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ProceedToNextRoom(ctx, dungeonID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
