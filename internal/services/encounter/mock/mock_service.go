...
//
//	mockgen -destination=mock/mock_service.go -package=mockencounter -source=service.go
//
...
func (m *MockService) AddMonster(ctx context.Context, encounterID, userID string, input *encounter.AddMonsterInput) (*combat.Combatant, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) AddPlayer(ctx context.Context, encounterID, playerID, characterID string) (*combat.Combatant, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CreateEncounter(ctx context.Context, input *encounter.CreateEncounterInput) (*combat.Encounter, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetActiveEncounter(ctx context.Context, sessionID string) (*combat.Encounter, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetEncounter(ctx context.Context, encounterID string) (*combat.Encounter, error) {
	m.ctrl.T.Helper()
