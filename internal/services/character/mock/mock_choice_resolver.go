...
//
//	mockgen -destination=mock/mock_choice_resolver.go -package=mockcharacter -source=choice_resolver.go
//

// Package mockcharacter is a generated GoMock package.
package mockcharacter
