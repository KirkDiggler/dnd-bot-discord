...
//
//	mockgen -destination=mock/mock_service.go -package=mockcharacters -source=service.go
//
...
import (
	...
	shared "github.com/KirkDiggler/dnd-bot-discord/internal/domain/shared"
	character0 "github.com/KirkDiggler/dnd-bot-discord/internal/services/character"
...
func (m *MockService) CreateCharacter(ctx context.Context, input *character0.CreateCharacterInput) (*character0.CreateCharacterOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCharacter", ctx, input)
	ret0, _ := ret[0].(*character0.CreateCharacterOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateCharacter indicates an expected call of CreateCharacter.
func (mr *MockServiceMockRecorder) CreateCharacter(ctx, input any) *gomock.Call {
...
func (m *MockService) FinalizeCharacterWithName(ctx context.Context, characterID, name, raceKey, classKey string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FinalizeDraftCharacter(ctx context.Context, characterID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) FinalizeDraftCharacter(ctx, characterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) FixCharacterAttributes(ctx context.Context, characterID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetByID(characterID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetCharacter(ctx context.Context, characterID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) GetCharacterCreationSession(ctx context.Context, sessionID string) (*character.CharacterCreationSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCharacterCreationSession", ctx, sessionID)
	ret0, _ := ret[0].(*character.CharacterCreationSession)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) GetCharacterFromSession(ctx context.Context, sessionID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetClass(ctx, classKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) GetOrCreateDraftCharacter(ctx context.Context, userID, realmID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetOrCreateDraftCharacter(ctx, userID, realmID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetRace(ctx, raceKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetRaces(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) ListCharacters(ctx context.Context, userID string) ([]*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) ResolveChoices(ctx context.Context, input *character0.ResolveChoicesInput) (*character0.ResolveChoicesOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolveChoices", ctx, input)
	ret0, _ := ret[0].(*character0.ResolveChoicesOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ResolveChoices indicates an expected call of ResolveChoices.
func (mr *MockServiceMockRecorder) ResolveChoices(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockService) StartCharacterCreation(ctx context.Context, userID, guildID string) (*character.CharacterCreationSession, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) StartFreshCharacterCreation(ctx context.Context, userID, realmID string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateDraftCharacter(ctx context.Context, characterID string, updates *character0.UpdateDraftInput) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) UpdateEquipment(arg0 *character.Character) error {
	m.ctrl.T.Helper()
...
func (m *MockService) ValidateCharacterCreation(ctx context.Context, input *character0.ValidateCharacterInput) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) ValidateCharacterCreation(ctx, input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
