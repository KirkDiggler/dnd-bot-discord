...
// ListClassFeatures mocks base method.
func (m *MockClient) ListClassFeatures(classKey string, level int) ([]*entities.CharacterFeature, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListClassFeatures", classKey, level)
	ret0, _ := ret[0].([]*entities.CharacterFeature)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListClassFeatures indicates an expected call of ListClassFeatures.
func (mr *MockClientMockRecorder) ListClassFeatures(classKey, level any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListClassFeatures", reflect.TypeOf((*MockClient)(nil).ListClassFeatures), classKey, level)
}
